<template>
    ...
    <section class="max-w-4xl m-auto flex flex-col justify-center items-center mt-12" id="search">
        ...
        <form @submit.prevent="searchHandler" class="bg-slate-50 p-3 rounded-lg flex items-center justify-center w-96">
            <input  class="border-0 py-2 rounded-md outline-none w-56 text-black" v-model="search" type="text" name="text" placeholder="movie ...">
            <input type="submit" value="Search" class="btn border-0 outline-none  uppercase font-medium cursor-pointer border-none  w-24">
        </form>
    </section>
